...
<div class="page-title">
	...
	<div class="title-env">
		<h1 class="title">Store Wise Lead Summary</h1>
     ...
     function dateFromSelect(data)
		{
     	...
     	//$("#customerListGrid").show();
			$("#customerListGrid").dataTable({
               ...
               "processing": true,
               "serverSide": true,   
               "ajax": "/dashboard/getAllCustomerLeads?from="+from,
     ...
     function dateToSelect()
		{
     	...
     	//$("#customerListGrid").show();
			$("#customerListGrid").dataTable({
               ...
               "processing": true,
               "serverSide": true,                              
               "ajax": "/dashboard/getAllCustomerLeads?from="+from+"&to="+to+"&lead_type="+lead_type+"&lead_status="+lead_status,
               ///"ajax": "/students/index?schoolId=" +schoolId,
                 "aLengthMenu": [
					[20, 25, 50, 100, -1], [20, 25, 50, 100, "All"]
                 ],
				...
				<div class="col-md-12">
					...
					jQuery(document).ready(function($)
					{
						$("#customerListGrid").dataTable({
                              "processing": true,
                              "serverSide": true,                              
                              "ajax": "/dashboard/getAllCustomerLeads",
                                "aLengthMenu": [
								[20, 25, 50, 100, -1], [20, 25, 50, 100, "All"]
                                ],
                               "columns": [
										...
										<div class="modal-body">
											...
											<div class="row">
												<div class="col-md-4">
													<ul class="list-unstyled line-height-default">
														<li><b>Name:</b> <span
															class="pull-right ajax-content-name">Loading...</span></li>
													</ul>
												</div>
											...
											<div class="row">
												<div class="col-md-4">
													<ul class="list-unstyled line-height-default">
														<li><b>Dial:</b> <span
															class="pull-right ajax-content-dial">Loading...</span></li>
													</ul>
												</div>
												...
												<div class="col-md-4">
													<ul class="list-unstyled line-height-default">
														<li><b>Crown:</b> <span
															class="pull-right ajax-content-crown">Loading...</span></li>
													</ul>
											...
											<div class="row">
												<div class="col-md-4">
													<ul class="list-unstyled line-height-default">
														<li><b>Hands:</b> <span
															class="pull-right ajax-content-hands">Loading...</span></li>
													</ul>
												</div>
