...
<div class="page-title">
	...
	<div class="title-env">
		<h1 class="title">Employee Wise Lead Summary</h1>
     ...
     function dateFromSelect(data)
		{
     	...
     	//$("#customerListGrid").show();
			$("#customerListGrid").dataTable({
               ...
               "processing": true,
               "serverSide": true,   
               "ajax": "/dashboard/getAllEmployees?from="+from,
     ...
     function dateToSelect()
		{
     	...
     	//$("#customerListGrid").show();
			$("#customerListGrid").dataTable({
               ...
               "processing": true,
               "serverSide": true,                              
               "ajax": "/dashboard/getAllEmployees?from="+from+"&to="+to+"&lead_type="+lead_type+"&lead_status="+lead_status,
               ///"ajax": "/students/index?schoolId=" +schoolId,
                 "aLengthMenu": [
					[10, 25, 50, 100, -1], [10, 25, 50, 100, "All"]
                 ],
				...
				<div class="col-md-12">
					...
					jQuery(document).ready(function($)
					{
						$("#customerListGrid").dataTable({
                              "processing": true,
                              "serverSide": true,                              
                              "ajax": "/dashboard/getAllEmployees",
                                "aLengthMenu": [
								[10, 25, 50, 100, -1], [10, 25, 50, 100, "All"]
                                ],
                               "columns": [
