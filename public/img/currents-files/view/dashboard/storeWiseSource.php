...
<div class="page-title">
	...
	<div class="title-env">
		<h1 class="title">Store Wise Source Summary</h1>
                   ...
                   $(document).ready(function($)
                    ...
                    function dateFromSelect(data)
					{
						...
						$("#customerListGrid").dataTable({
                              ...
                              "processing": true,
                              "serverSide": true,   
                              "ajax": "/dashboard/getAllStoreSource?from="+from,
                   ...
                   $(document).ready(function($)
                    ...
                    function dateToSelect()
					{
						...
						$("#customerListGrid").dataTable({
                              ...
                              "processing": true,
                              "serverSide": true,                              
                              "ajax": "/dashboard/getAllStoreSource?from="+from+"&to="+to+"&lead_type="+lead_type+"&lead_status="+lead_status,
                              ///"ajax": "/students/index?schoolId=" +schoolId,
                                "aLengthMenu": [
								[20, 25, 50, 100, -1], [20, 25, 50, 100, "All"]
                                ],
				...
				<div class="col-md-12">
					...
					jQuery(document).ready(function($)
					{
						$("#customerListGrid").dataTable({
                              "processing": true,
                              "serverSide": true,                              
                              "ajax": "/dashboard/getAllStoreSource",
                                "aLengthMenu": [
								[20, 25, 50, 100, -1], [20, 25, 50, 100, "All"]
                                ],
                               "columns": [
