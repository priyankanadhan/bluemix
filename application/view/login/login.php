...
<head>
	...
	<link rel="stylesheet" href="<?php echo URL_LENCO; ?>css/fonts/linecons/css/linecons.css">
	<link rel="stylesheet" href="<?php echo URL_LENCO; ?>css/fonts/fontawesome/css/font-awesome.min.css">
	...
	<link rel="stylesheet" href="<?php echo URL_LENCO; ?>css/xenon-forms.css">
	<link rel="stylesheet" href="<?php echo URL_LENCO; ?>css/xenon-components.css">
	<link rel="stylesheet" href="<?php echo URL_LENCO; ?>css/xenon-skins.css">
	...
	<div class="login-container">
		...
		<div class="row">
			...
			<div class="col-sm-6">
				...
				<form method="post" role="form" id="login" class="login-form fade-in-effect" action="/login/index">
	
					<div class="login-header">
						<a href="#" class="logo">
							<img src="<?php echo URL_LENCO; ?>images/logo-white-bg@2x.png" alt="" width="80" />
							<!--span>log in</span-->
						</a>
