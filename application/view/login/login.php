...
<body class="page-body login-page login-light" style="background-image:url('../images/login_backgrd.jpg')">
	...
	<div class="login-container">
		...
		<div class="row">
			...
			<div class="col-sm-6">
				...
				<div class="external-login" style="width: 70%; padding-left: 25%;">
